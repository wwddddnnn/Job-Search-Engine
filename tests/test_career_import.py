...
from job_search_assistant.career import DocumentStatus
from job_search_assistant.core import ConflictError, RequestContext
...
class CareerImportTestCase(unittest.TestCase):
    ...
    def test_success_retains_original_file_and_extracted_text(self) -> None:
        ...
        self.assertTrue((self.storage.root_dir / document.content_hash / "original.bin").is_file())
